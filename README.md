...
Verschillende ontstekingsgerelateerde genen waren verhoogd tot expressie in de RA-groep, waaronder CXCL8 (log2FC = 8,90; padj = 2,35 × 10⁻¹¹), MMP9 (log2FC = 4,12; padj = 5,24 × 10⁻⁵) en CCL2 (log2FC = 1,72; padj = 0,033). 
