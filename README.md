# Ontrafeling van reumatoïde artritis met transcriptomics *RNA-sequencing, differentiële genexpressie en pathwayanalyse van synoviumbiopten*
...
## Resultaten
Om genen te identificeren die verschillen in expressie tussen reumatoïde artritis (RA) patiënten en gezonde controles, werd een differentiële genexpressieanalyse met [DESeq2](tabellen/DESeq2_resultaten.csv) uitgevoerd op RNA-sequencingdata van vier RA-patiënten en vier gezonde controles. In totaal werden 25.579 genen geanalyseerd. Hiervan waren 3.275 genen significant verhoogd en 3.170 genen significant verlaagd in RA ten opzichte van de controlegroep (aangepaste p-waarde < 0,05). De [10 meest significant differentieel geëxprimeerde genen](tabellen/tabel1_top10_DE_genen.csv) werden gerangschikt op basis van de aangepaste p-waarde. De verschillen in genexpressie werden gevisualiseerd met behulp van een [volcano plot](figuren/figuren/1volcano_plot.png.md), waarin CXCL8, MMP9, CCL2 en BAX afzonderlijk zijn gelabeld.

Onder de differentieel geëxprimeerde genen waren CXCL8 (log2FC = 8,90; padj = 2,35 × 10⁻¹¹), MMP9 (log2FC = 4,12; padj = 5,24 × 10⁻⁵) en CCL2 (log2FC = 1,72; padj = 0,033) verhoogd in de RA-groep.

Om de biologische functies van de differentieel geëxprimeerde genen te onderzoeken, werd een [Gene Ontology](figuren/figuren/1dotplot_GO_analyse.png.md) analyse uitgevoerd. Hierbij werden voornamelijk biologische processen gerelateerd aan immuunresponsen en lymfocytactivatie gevonden, waaronder B-cel gemedieerde immuniteit, immunoglobuline-gemedieerde immuunrespons en lymfocytactivatie.

Daarnaast werd een KEGG-enrichmentanalyse uitgevoerd. Hierbij werden verschillende immuun- en ontstekingsgerelateerde pathways gevonden, waaronder de [TNF](figuren/figuren/pathway_TNF_signaling.png.md), T-celreceptor-, NF-κB- en [IL-17-signaalroutes](figuren/figuren/1IL_17_signaling_pathway.md). De top 10 verrijkte pathways zijn weergegeven in de [KEGG-dotplot](figuren/figuren/1KEGGdotplot.png.md).
