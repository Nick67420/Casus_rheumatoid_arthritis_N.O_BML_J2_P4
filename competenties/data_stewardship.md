...
**scripts/** – bevat het volledige R-script en rauwe sequencingdata waarmee de RNA-sequencingdata zijn verwerkt en geanalyseerd. Daarnaast zijn de verschillende analysemethoden, zoals mapping, DESeq2, GO- en KEGG-analyse, afzonderlijk gedocumenteerd.
